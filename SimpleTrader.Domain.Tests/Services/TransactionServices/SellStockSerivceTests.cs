...
{
    [TestFixture]
    public class SellStockSerivceTests
    {
        ...
        public void SellStock_WithInsufficientShares_ThrowsInsufficientSharesException()
        {
            ...
            if (Assert.ThrowsAsync<InsufficientSharesException>(
                        () => _sellStockService.SellStock(seller, expectedSymbol, expectedRequiredShares))
                is InsufficientSharesException exception)
            {
        ...
        public void SellStock_WithInvalidSymbol_ThrowsInvalidSymbolExceptionForSymbol()
        {
            ...
            if (Assert.ThrowsAsync<InvalidSymbolException>(() => _sellStockService.SellStock(seller, expectedInvalidSymbol, 5))
                is InvalidSymbolException exception)
            {
